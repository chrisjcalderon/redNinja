define([
    ...
    var model = function () {
        ...
        self.onInit = function () {
            ...
            template.getSection("main-top").positions[1].addModule(new templates.Module("myname", "spa/moveModule", "spa/moveModule", " top here ", "Top")).showTitle(true);
            template.getSection("main-top").positions[2].addModule(new templates.Module("myname", "spa/moveModule", "spa/moveModule", " top here ", "Top")).showTitle(true);
            template.getSection("main-top").positions[3].addModule(new templates.Module("myname", "spa/moveModule", "spa/moveModule", " top here ", "Top")).showTitle(true);
